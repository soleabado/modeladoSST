...
def example():
    ...
    ### Setup the topology
    ### *********************************************************************
    ### NUEVOS PARAMETROS (INTENTO II)
    ### *********************************************************************

    topo = topoFatTree()
    topo.shape = "8,8:32,32:32"
    ...
    networkif.input_buf_size = "128kB"
    networkif.output_buf_size = "128kB"
	...
	"filepath" : "emberhalo3d_8Knodos_fattree_random.csv",
	"separator" : ", "
	})
